...
function promedioResultadosTest(resultadosTest) {
   ...
   return promedio = totalNotas / resultadosTest.length
}
...
function empiezaConNueve(num) {
   ...
   return string.charAt(0) === '9'? true : false
}
...
function mesesDelAño(array) {
   ...
   for(let i = 0; i < array.length; i++){
      if(months.includes(array[i])) found.push(array[i])
   }
...
function breakStatement(num) {
   ...
   return sum === i ? 'Se interrumpio la ejecución' : array
}
